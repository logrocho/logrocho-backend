...
- /bar:
    ...
    - Descripcion: Devuelve un bar para una clave primaria dada.
    ...
    - Respuesta: Objeto `{status:boolean, data:Bar}` con el bar obtenido.
            ...
            ```
- /updateBar: **Accion exclusiva de usuarios con el rol admin**
...
- /insertBar: **Accion exclusiva de usuarios con el rol admin**
...
- /deleteBar: **Accion exclusiva de usuarios con el rol admin**
...
- /pincho:
    ...
    - Respuesta: Objeto `{status:boolean, data:Pincho}` con el pincho obtenido.
            ...
            ```
- /updatePincho: **Accion exclusiva de usuarios con el rol admin**
...
- /insertPincho: **Accion exclusiva de usuarios con el rol admin**
...
- /deletePincho: **Accion exclusiva de usuarios con el rol admin**
